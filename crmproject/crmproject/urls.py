...
from crmapp.views import register_employee, ManagerLoginView, listings_admin, get_employee, update_employees, add_employee, delete_employee, listings_employee
